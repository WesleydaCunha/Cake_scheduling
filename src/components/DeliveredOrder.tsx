...
export function DeliveredOrder() {
    ...
    const filteredOrders = useMemo(() =>
        orders.filter(order =>
            ...
            new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(Number(order.amount)).toLowerCase().includes(searchTerm.toLowerCase()) ||
        ...
        <TabsContent value="entregue">
            <Card className="p-6 shadow-lg">
                <div>
                    ...
                    <ScrollArea className="min-w-[300px] sm:min-w-[500px] lg:min-w-[550px] xl:min-w-[700px] 2xl:min-w-[950px]  h-[350px] ">
                        <Table>
                            <TableHeader>
