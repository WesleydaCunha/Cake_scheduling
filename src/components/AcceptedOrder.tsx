...
export function AcceptedOrder() {
    ...
    const columns: ColumnDef<typeof orders[0]>[] = useMemo(() => [
        {
            accessorKey: "name",
            header: "Nome",
        },
        ...
        },
        {
            ...
            header: "Ação",
            cell: () => (
                <Button className="text-sm w-full">Entregar</Button>
            )
        },
    ], []);
        ...
        <TabsContent value="concluido">
            <Card className="p-6 shadow-lg">
                <div>
                    ...
                    <ScrollArea className=" sm:min-w-[350px] lg:min-w-[650px] xl:min-w-[700px] 2xl:min-w-[950px]  h-[350px] ">
